...
screens' routes (most still placeholders). ~3 weeks to MVP, ~5.5 weeks to
production-ready.
...
- [ ] Sign-in / access gate (`3a`) — can be a simplified mock, doesn't need
      all four states to prove the concept
