...
// Word-boundary'd on intern/co-op -- found via fetch-greenhouse-stripe's
// pilot against real Stripe titles: unbounded /intern(ship)?/ matches
// "Internal Audit Lead" and "International Accounting Lead" as substrings,
